...
const posts = [
  { title: "Why Data Silos Are Costing You More Than You Think", slug: "why-data-silos-costing-more", category: "Industry", date: "Nov 12, 2025", excerpt: "The Hidden Cost of Fragmented Data. The vast majority of businesses run on data, with each set of data not connected to the others without significant engineering work.", featured: true, readTime: "8 min" },
  { title: "From Raw Data to Unified Intelligence in 4 Stages", slug: "raw-data-to-unified-intelligence", category: "Technical", date: "Jan 24, 2026", excerpt: "The Convergence Pipeline Explained. Connecting your data sources is a relatively easy thing to do. What's much more difficult is fixing the problems between the data you merged.", featured: false, readTime: "7 min" },
  { title: "Why Batch Processing Is a Liability for Data Teams", slug: "batch-processing-liability-data-teams", category: "Insights", date: "Feb 15, 2026", excerpt: "The Case for Sub-Second Data Sync. In the past, batch processing made sense because the costs of storage were high and compute was limited. Today this trade off doesn’t exist.", featured: false, readTime: "6 min" },
