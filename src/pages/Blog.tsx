...
const posts = [
  { title: "The Rise of Data Convergence in 2026", category: "Industry", date: "Mar 20, 2026", excerpt: "How enterprises are moving beyond traditional ETL to AI-powered data unification.", featured: true, readTime: "6 min" },
  { title: "DataVerGAI: Under the Hood", category: "Product", date: "Mar 15, 2026", excerpt: "A deep dive into the architecture powering real-time data synthesis.", featured: false, readTime: "8 min" },
  { title: "5 Signs Your Data Stack Is Fragmented", category: "Insights", date: "Mar 10, 2026", excerpt: "Identify the warning signs and learn how convergence can help.", featured: false, readTime: "4 min" },
  { title: "Building Predictive Models with Unified Data", category: "Technical", date: "Mar 5, 2026", excerpt: "Leveraging DataVerGAI's ML pipeline for actionable predictions.", featured: false, readTime: "7 min" },
  { title: "SOC 2 Compliance: Our Journey", category: "Security", date: "Feb 28, 2026", excerpt: "How DataVerge achieved enterprise-grade security certification.", featured: false, readTime: "5 min" },
  { title: "Customer Spotlight: Acme Corp", category: "Case Study", date: "Feb 20, 2026", excerpt: "How Acme Corp reduced data processing time by 80% with DataVerge.", featured: false, readTime: "3 min" },
];
    ...
    <section className="relative bg-background pt-32 pb-24 overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <AnimatedSection delay={0.15}>
          <GlowCard className="group overflow-hidden bg-card border-border" hoverScale={1.01}>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[320px]">
          ...
          <AnimatedSection delay={0.2} className="lg:col-span-1 lg:row-span-2">
            <GlowCard className="h-full bg-card group flex flex-col justify-between p-8 border-border" hoverScale={1.02}>
              <div>
          ...
          <AnimatedSection delay={0.3} className="md:col-span-2 lg:col-span-2 lg:row-span-1">
             <GlowCard className="h-full bg-card group overflow-hidden border-border" hoverScale={1.02}>
               <div className="grid md:grid-cols-2 h-full">
                  ...
                  <div className="hidden md:flex relative border-l border-border bg-gradient-to-br from-background to-secondary overflow-hidden items-center justify-center">
          ...
          <AnimatedSection delay={0.5} className="col-span-1">
             <GlowCard className="h-full bg-foreground text-background group flex flex-col justify-between p-8 border-none" hoverScale={1.02}>
              <div>
