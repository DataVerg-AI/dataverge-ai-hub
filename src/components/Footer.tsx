        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link to="/product" className="text-sm text-foreground/70 transition-colors hover:text-accent">DataVerGAI</Link>
              <Link to="/pricing" className="text-sm text-foreground/70 transition-colors hover:text-accent">Pricing</Link>
              <Link to="/blog" className="text-sm text-foreground/70 transition-colors hover:text-accent">Blog</Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link to="/about" className="text-sm text-foreground/70 transition-colors hover:text-accent">About</Link>
              <Link to="/contact" className="text-sm text-foreground/70 transition-colors hover:text-accent">Contact</Link>
              <Link to="/terms" className="text-sm text-foreground/70 transition-colors hover:text-accent">Terms</Link>
              <Link to="/privacy" className="text-sm text-foreground/70 transition-colors hover:text-accent">Privacy</Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              {["Twitter", "LinkedIn", "GitHub"].map((s) => (
                <a key={s} href="#" className="text-xs text-foreground/50 transition-colors hover:text-accent">{s}</a>
              ))}
            </div>
          </div>
        </div>
